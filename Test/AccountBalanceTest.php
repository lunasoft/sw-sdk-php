...
final class AccountBalanceTest extends TestCase
{
    ...
    public function testSuccessGetBalanceByUserIdByToken()
    {
        $resultSpect = "success";
        $params = array(
            "urlApi" => "https://api.test.sw.com.mx",
        ...
        $accountBalance = AccountBalanceService::Set($params);
        $result = $accountBalance::GetBalanceByUserId("fafb2ac2-62ca-49f8-91de-14cea73b01eb");
        $this->assertEquals($resultSpect, $result->status);
        $this->assertNotEmpty($result->data);
    }
    public function testSuccessGetBalanceByUserIdByAuth()
    {
        $resultSpect = "success";
        $params = array(
            "url"=>"https://services.test.sw.com.mx",
    ...
    public function testErrorGetBalanceByUserId()
    {
        $resultSpect = "error";
        $params = array(
            "urlApi" => "https://api.test.sw.com.mx",
        ...
        $accountBalance = AccountBalanceService::Set($params);
        $result = $accountBalance::GetBalanceByUserId("00000000-0000-0000-0000-000000000000");
        $this->assertEquals($resultSpect, $result->status);
    }
}
