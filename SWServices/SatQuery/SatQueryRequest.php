...
class SatQueryRequest{
    ...
    public static function soapRequest($url, $rfcEmisor, $rfcReceptor, $total, $uuid, $fe8){
        $xml_post_string = SatQueryRequest::getSoapBody($rfcEmisor,$rfcReceptor, $total,$uuid,$fe8);
    ...
    public static function getSoapBody($rfcEmisor,$rfcReceptor, $total,$uuid, $fe8){
        return '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:tem="http://tempuri.org/">
                               <soapenv:Header/>
                               <soapenv:Body>
                                  <tem:Consulta>
                                      <tem:expresionImpresa><![CDATA[?re='.$rfcEmisor.'&rr='.$rfcReceptor.'&tt='.$total.'&id='.$uuid.'&fe='.$fe8.']]></tem:expresionImpresa>
                                  </tem:Consulta>
                               </soapenv:Body>
                            </soapenv:Envelope>';
    }
